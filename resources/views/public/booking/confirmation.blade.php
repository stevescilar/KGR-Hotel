...
<style>
    ...
    .btn-print { flex:1; text-align:center; border:2px solid var(--mist); color:var(--fern); padding:0.85rem; border-radius:10px; font-size:0.85rem; font-weight:600; text-decoration:none; cursor:pointer; background:none; font-family:'Jost',sans-serif; }
        ...
        <div class="confirm-card">
            ...
            <div class="confirm-body">
                ...
                <div class="payment-confirmed">
                    <div><div class="lbl">Amount Paid</div><div class="amount">KES {{ number_format($booking->total_amount) }}</div></div>
                    <div class="status">✓ Paid via M-Pesa</div>
                </div>
                <div class="checkin-notice">
                    <strong>📋 Check-in Information</strong>
                    Check-in time is from <strong>2:00 PM</strong>. Please bring a copy of this confirmation and a valid ID. Early check-in is subject to availability.
